...
Route::post('/clientes/actualizar/{id}', [ClienteController::class, 'actualizar'])
   ...
   Route::get('/categorias/editar/{id}',
    [CategoriaController::class, 'editar'])
    ->name('categorias.editar');

Route::post('/categorias/actualizar/{id}',
    [CategoriaController::class, 'actualizar'])
    ->name('categorias.actualizar');

    Route::get('/consolas/editar/{id}',
    [ConsolaController::class,'editar'])
    ->name('consolas.editar');

Route::post('/consolas/actualizar/{id}',
    [ConsolaController::class,'actualizar'])
    ->name('consolas.actualizar');

    Route::get('/proveedores/editar/{id}',
    [ProveedorController::class,'editar'])
    ->name('proveedores.editar');

Route::post('/proveedores/actualizar/{id}',
    [ProveedorController::class,'actualizar'])
    ->name('proveedores.actualizar');
    Route::get('/empleados/editar/{id}',
    [EmpleadoController::class,'editar'])
